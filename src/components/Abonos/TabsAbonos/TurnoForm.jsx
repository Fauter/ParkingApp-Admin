...
const TurnoForm = ({ onClose, user }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const resVehiculo = await fetch(`https://apiprueba.garageia.com/api/vehiculos/${patente}`);
      if (!resVehiculo.ok) {
      ...
      // Obtener precio
      const resPrecio = await fetch('https://apiprueba.garageia.com/api/precios/');
      ...
      const resTurno = await fetch('https://apiprueba.garageia.com/api/turnos', {
        method: 'POST',
